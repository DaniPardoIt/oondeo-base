...
//* RANDOM PASSWORD
function randomPassword( $passLength = 8, $alphabet = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890' )
{
...
function oondeo_base_enqueue_scripts(){
	...
	wp_enqueue_script( 'oondeo-base-js', plugin_dir_url( __FILE__ ) . 'js/oondeo-base.js' );
}
